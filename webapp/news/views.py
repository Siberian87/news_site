...
def single_news(news_id):
    ...
    another_news = News.query.order_by(News.url).all()

    if not my_news:
        abort(404)

    return render_template('news/single_news.html', page_title=my_news.title, news=my_news, another_news=another_news)
